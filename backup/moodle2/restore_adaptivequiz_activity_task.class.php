...
class restore_adaptivequiz_activity_task extends restore_activity_task {
    ...
    /**
     * Define the restore log rules that will be applied by the {@see restore_logs_processor} when restoring adaptivequiz logs.
     *
     * It must return one array of {@see restore_log_rule} objects.
     *
    ...
    /**
     * Define the restore log rules that will be applied by the {@see restore_logs_processor} when restoring course logs.
     *
     * It must return one array of {@see restore_log_rule} objects. Note these rules are applied when restoring course logs
     * by the restore final task, but are defined here at activity level. All them are rules not linked to any module instance
     * (cmid = 0).
     *
     * @return array An array of restore_log_rule objects.
     */
