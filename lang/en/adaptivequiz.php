...
$string['mod_form:algorithmsettingsheading'] = 'Algorithm settings';
$string['modformcatmodel'] = 'CAT model';
$string['modformcatmodel_help'] = 'Select one of the CAT model sub-plugins installed to use as a CAT model implementation.';
