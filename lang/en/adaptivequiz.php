...
$string['modformcatmodelheading'] = 'CAT model';
$string['modformquestionselectionheading'] = 'Question selection';
...
$string['showabilitymeasure_help'] = 'Sometimes it may be useful to reveal ability estimations to students after taking an adaptive quiz. With this setting enabled a student may see ability estimation in the attempts summary and right after finishing an attempt as well. Please, note, that this setting is applied only when the default CAT algorithm is used.';
...
$string['reportattemptgraphtitle'] = 'Attempt Graph';
$string['reportattemptquestionsdetailstab'] = 'Questions Details';
$string['reportattemptreviewpageheading'] = 'Attempt by {$a->fullname} submitted on {$a->finished}';
...
$string['answerdistgraph_title'] = 'Answer Distribution';
